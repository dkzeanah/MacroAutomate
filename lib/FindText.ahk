	  ...
	  */
	  ...
	  Gui(cmd, arg1:="", args*)
	  {
		...
		Case "MakeMainWindow":
		  ...
		  FindText_Main.Add("Edit", "x+0 w60 Limit5 Number")
		  ogcUpDownMyww := FindText_Main.Add("UpDown", "vMyww range1-" . SysGet(78), ww)
		  FindText_Main.Add("Text", "x+15 ys", Lang["Myhh"] ": ")
		  FindText_Main.Add("Edit", "x+0 w60 Limit5 Number")
		  ogcUpDownMyhh := FindText_Main.Add("UpDown", "vMyhh range1-" . SysGet(79), hh)
