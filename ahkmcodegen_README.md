...
"mcode'" is what the **AutoHotkey** forums call machine code embedded in script files. These functions are called to make certain calculations faster. While **AutoHotkey** - especially version 2 - is a capable language, it is interpreted, therefore everything but fast. More about mcode's inception here: httpshttps://www.autohotkey.com/boards/viewtopic.php?f=7&t=32
